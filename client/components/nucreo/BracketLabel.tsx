  ...
  return (
    ...
    >
      ...
      >
        <defs>
          ...
          >
            ...
            <stop
              offset="1"
              stopColor={variant === "blue" ? "#2D1ACA" : "#AD0000"}
            />
          </linearGradient>
        </defs>
        <path
          d="M45.8496 2.5H2.49997V92.4875H45.8496"
          stroke={`url(#bracket-open-${variant})`}
          strokeWidth="5"
        />
      </svg>
      <span
        className={`text-xs uppercase tracking-wider font-medium bg-gradient-to-r ${gradientClass} bg-clip-text text-transparent`}
      >
        {children}
      </span>
      <svg
      ...
      >
        ...
        <path
          d="M0 2.5H43.3496V92.4875H0"
          stroke={`url(#bracket-close-${variant})`}
          strokeWidth="5"
        />
      </svg>
    </motion.div>
